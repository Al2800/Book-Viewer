...
export const appStoreScreenshots = [
  {
    ...
    body: 'Tactile 3D bookshelf and daily serendipity for your personal quote library.',
    accent: colours.rust,
    source: '01_library_grid.png',
  },
  {
    id: 'Studio',
    title: 'Design editorial quote cards.',
    body: 'Style passages with Dark Linen, Warm Vellum and export to Obsidian or Notion.',
    accent: colours.gold,
    source: '08_quote_studio.png',
  },
  {
    id: 'Capture',
    title: 'A quiet camera for marked pages.',
    body: 'Full-bleed viewfinder, one shutter, and a Passages sheet when the page is readable.',
    accent: colours.gold,
    source: '06_captured_page.png',
  },
  {
    id: 'Passages',
    title: 'Review passages before they land in your library.',
    body: 'Edit the extracted line, keep the page photo, then save to your reading memory.',
    accent: colours.green,
    source: '07_extraction_review.png',
  },
  {
    id: 'Review',
    title: 'Review every word with clarity.',
    body: 'Refine margin notes in organic script and manage AI topic tags.',
    accent: colours.rust,
  ...
  },
  {
    ...
    body: 'Saved quotes remain organised by title, author, collection and page.',
    accent: colours.navy,
  ...
  },
  {
    ...
    body: 'Search across books, tags, and saved passages from one place.',
    accent: colours.green,
