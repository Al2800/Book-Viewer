...
export const appStoreScreenshots = [
  ...
  {
    id: 'Capture',
    title: 'Smart AR camera finds your marks.',
    body: 'Live vision overlays frame underlined passages with zero friction.',
    accent: colours.gold,
    source: '06_captured_page.png',
  },
  {
    id: 'Extraction',
    title: 'AI illuminates marked passages.',
    body: 'Visual provenance connects extracted quotes directly to the original page photo.',
