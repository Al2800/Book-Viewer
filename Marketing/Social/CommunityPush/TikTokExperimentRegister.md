...
Each post tests one primary hypothesis. Record the expected result before publishing and compare
the post with an appropriate format and content-territory baseline.

Confidence levels:

- `Low`: plausible prior without BookQuotes account evidence.
- `Medium`: supported by relevant external evidence or repeated directional account signals.
- `High`: repeated BookQuotes evidence across comparable executions.
...
| ID | Hypothesis | Territory | Style | Variable | Primary measure | Secondary measure | Confidence | Status | Next decision |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TK-001 | A precise presidential-biography reading route will earn more saves than a generic best-books list. | Recommendation | BQ-01 | Reader-need framing | Saves/1,000 views | Meaningful comments/1,000 | Medium prior | Pending | Complete evidence and rights gate, then publish carousel. |
| TK-002 | Handwritten relationships will improve completion when each mark explains a real connection. | Recommendation | BQ-02 | Explanatory animation | Completion | Saves/1,000 views | Low prior | Pending | Revise prototype and compare with a static treatment. |
...
| Content ID | Experiment | Checkpoint | Visible result | Deeper measures | Interpretation |
| --- | --- | --- | --- | --- | --- |
| `7678034754557529376` | Category Reel `cr-07` metadata audit | Initial audit | 231 views, 0 likes, 0 comments | Reach, watch completion, saves, shares, profile visits and follows Not available | Public row reads `#Zernio`; intended Inbox ID `7677955167269996566` is absent. Exclude from creative comparison. |

The *Tinker Tailor* Inbox draft `7677958495261493270` has no live analytics
row. No confidence or result label changed. The single-writer, metadata and
second-slot holds remain active; do not upload, schedule, edit or delete
another TikTok copy automatically.
...
| Content ID | Experiment | Checkpoint | Visible result | Deeper measures | Interpretation |
| --- | --- | --- | --- | --- | --- |
| `7670655931193068823` | TK-008 | Pre-72-hour check, approximately 58 hours | 0 views, 0 likes, 0 comments | Account last-7-days totals 0; traffic source, search queries, retention, completion, saves, profile visits, follows and link taps Not available; comments says `No comments yet` | 72-hour checkpoint due 8 August 22:02 Europe/London. Distribution/measurement blocker persists; no result label. |

No confidence or result label changed. The post is Public and appears once; do not treat the visible
zeroes as a creative verdict before the attributable checkpoint.
...
| Content ID | Experiment | Checkpoint | Visible result | Deeper measures | Interpretation |
| --- | --- | --- | --- | --- | --- |
| `7667570006032387350` | TK-005 | 7-day-plus check | 0 views, 0 likes, 0 comments | Not available | Distribution/measurement blocker; not a creative verdict. |
| `7667846219120626966` | Not yet checkpointed | Public audit | 0 views, 0 likes, 0 comments | Not available | Do not compare until attributable analytics are available. |
...
| `7668631665064938774` | TK-008 | 96-hour-plus check | 0 views, 0 likes, 0 comments | Not available | Distribution/measurement blocker; keep the reset gate active. |
...
| --- | --- |
| Experiment ID | |
| TikTok content ID and URL | |
| Published at | |
| Review checkpoint | 24h / 72h / 7d |
| Views | |
| Average watch time | |
| Completion | |
| Saves/1,000 views | |
| Shares/1,000 views | |
| Meaningful comments/1,000 views | |
| Profile visits/1,000 views | |
| Follows/1,000 views | |
| Link taps | |
| Baseline used | |
| Observed audience language | |
| Confounds | |
| Result label | |
| Confidence change | |
| Decision | Repeat / Modify / Pause |

## Portfolio Rule

Build each weekly queue from:

- 70% proven or strongly supported formats;
