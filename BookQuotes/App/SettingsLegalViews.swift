            ...
            return [
                ...
                LegalDocumentSection(
                    ...
                    paragraphs: [
                        ...
                        "When you look up a book, BookQuotes sends an ISBN, or a book title and author, directly to Google Books to find metadata and cover images. If an ISBN is not found there, it is sent to Open Library as a fallback. These catalogue requests do not include your BookQuotes account identifier or library.",
                ...
                LegalDocumentSection(
                    ...
                    bullets: [
                        ...
                        "Google Books for requested ISBN, title, and author metadata lookups and cover images",
