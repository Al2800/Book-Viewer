...
- [ ] Simulator smoke covers Library/Search, capture review route, settings/account deletion presentation, and quote detail edit path where available.
...
- [ ] App Store privacy/account deletion/subscription notes are recorded for the submission checklist.
