# Verification: Quote Detail Edit Fields Refactor
...
```bash
xcodebuild test -quiet -project BookQuotes.xcodeproj -scheme BookQuotes -destination 'platform=iOS Simulator,name=iPhone 17,OS=26.5' -only-testing:BookQuotesTests/QuoteDetailEditFieldsTests
```
